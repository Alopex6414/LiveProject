...
// @Purpose: CLiveInLog获取Windows版本名称
// @Since: v1.00a
// @Para: None
// @Return: None
//------------------------------------------------------------------
